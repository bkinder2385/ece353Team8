...
)
{
  ...
  //==============================================================
	i2cSendByte(i2c_base, reg_address ,I2C_MCS_START | I2C_MCS_RUN |I2C_MCS_STOP); // ??is this correct?? replaced 0x00 with reg_address
...
)
{
  ...
  //==============================================================
	...
	status = i2cGetByte( i2c_base, data , I2C_MCS_START | I2C_MCS_RUN | I2C_MCS_STOP);   // ??removed * at data
...
{ 
  ...
  // This will require reading P1_XH and P1_XL
	...
	ft6x06_read_data(FT6X06_I2C_BASE, &beta);
	data = beta & 0x001111;
	data = (data << 8);
